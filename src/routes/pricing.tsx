  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <div key={p.name} className={`relative glass-card p-8 ${p.popular ? "shadow-neon border-primary/60" : ""}`}>
              ...
              <a href={WHATSAPP_BOOKING_URL} target="_blank" rel="noreferrer" className={`mt-7 block text-center rounded-md px-5 py-3 font-accent font-bold uppercase tracking-wider text-sm ${p.popular ? "bg-gradient-pink text-white shadow-neon-pink" : "glass-card hover:shadow-neon"}`}>
                Join {p.name}
              </a>
            </div>
          ))}
      ...
      <section className="mt-24 glass-card p-12 text-center">
        ...
        <a href={WHATSAPP_BOOKING_URL} target="_blank" rel="noreferrer" className="mt-6 inline-flex items-center rounded-md bg-gradient-pink px-7 py-3 font-accent font-bold uppercase tracking-wider text-white shadow-neon-pink hover:scale-105 transition">
