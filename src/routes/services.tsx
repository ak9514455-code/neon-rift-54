...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pick your platform: PS5, PS4, high-end gaming PCs, and VR. All set up for peak performance at Anytime Gaming Cafe, Haldwani." },
      { property: "og:title", content: "Services — PS5, PS4, PC & VR | Anytime Gaming Cafe" },
      { property: "og:description", content: "Pick your platform. PS5, PS4, PC, VR — all under one roof in Haldwani." },
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16">
      <header className="text-center mb-16">
        <p className="font-accent uppercase tracking-[0.3em] text-sm text-accent">Our gaming arsenal</p>
        <h1 className="mt-3 font-display text-5xl sm:text-7xl font-black uppercase text-glow">Pick Your Platform</h1>
      ...
      <div className="mt-20 text-center glass-card p-10">
        ...
        <p className="mt-4 text-lg font-accent uppercase tracking-wider">Can't decide? Come in and try them all.</p>
        <p className="mt-2 text-sm text-muted-foreground">New games added regularly.</p>
        <a href="https://wa.me/919876543210" target="_blank" rel="noreferrer" className="mt-6 inline-flex items-center gap-2 rounded-md bg-gradient-pink px-6 py-3 font-accent font-bold uppercase tracking-wider text-white shadow-neon-pink hover:scale-105 transition">
